...
export const generateDietOverviewForDay = async (date: string, mealsss: any[], water: number) => {
    const meals = {
        Breakfast: [
            {
                id: "1",
    ...
    const prompt = generateDietOverviewPrompt(summaryMeals, summaryNutrition, 3500);
